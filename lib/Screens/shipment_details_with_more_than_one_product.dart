                ...
                ((data.shipmentById!.status == 'available' ||
                    ...
                    : Container(
                        ...
                        child: Column(
                          children: [
                            Text(
                              'الاوردر ده عليه خصم علي سعر التوصيل\nهتحصل من العميل ${num.parse(data.shipmentById!.agreedShippingCostAfterDiscount!).toInt()} ج وهتستلم في محفظتك ${(num.parse(data.shipmentById!.agreedShippingCost!).toInt() - num.parse(data.shipmentById!.agreedShippingCostAfterDiscount!).toInt())} ج',
                              style: TextStyle(
                                fontSize: 14.0.sp,
                          ...
                          Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Text(
                                    intl.DateFormat('hh:mm a', 'ar-EG').format(
                                        DateTime.parse(data.shipmentById!
                                        ...
                                        (DateTime.parse(data.shipmentById!.dateToDeliverShipment!).day ==
                                            ...
                                            : (DateTime.parse(data.shipmentById!.dateToDeliverShipment!).day ==
                                                ...
                                                : (DateTime.parse(data.shipmentById!.dateToDeliverShipment!).day ==
                                                            DateTime.now().day -
                                                                1) &&
                                                        (DateTime.parse(data.shipmentById!.dateToDeliverShipment!)
                                                                .month ==
                                                            DateTime.now()
                                                                .month) &&
                                                        (DateTime.parse(data.shipmentById!.dateToDeliverShipment!).year ==
                                                                ...
                                                                .sendNotification(
                                                                    ...
                                                                    data: ShipmentNotification(
                                                                            ...
                                                                            merchantImage: data
                                                                                .shipmentById!.merchant!.photo,
                                                                            merchantName: data
                                                                                .shipmentById!.merchant!.name,
                                                                            childrenShipment:
                                                                                0,
                                                                            shippingCost:
                                                                                data.shipmentById!.expectedShippingCost,
                                                                            totalShipmentCost: data.shipmentById!.amount)
                                                                        .toMap());
                                                          },
                                                          isDone: true,
                                            ...
                                            HandleShipment(
                                              model: ShipmentTrackingModel(
                                                ...
                                                receivingLandmark: data
                                                    ...
                                                    .receivingLandmark,
                                                receivingLat: data
                                                    .shipmentById!.receivingLat,
                                                receivingLng: data
                                                    .shipmentById!.receivingLng,
                                                clientPhone: data
                                                    .shipmentById!.clientPhone,
                                                deliveringCity: data
                                                    .shipmentById!
                                                    .deliveringCity,
                                                receivingState: data
                                                ...
                                                merchantId: data
                                                    .shipmentById!.merchantId,
                                                courierId: data
                                                    .shipmentById!.courierId,
                                                merchantImage: data
                                                    .shipmentById!
                                                    .merchant!
                                                    .photo,
