import 'credit_status_details.dart';

class CreditStatusTransaction {
  int? id;
  String? amount;
  String? netAmount;
  String? bankCharge;
  ...
  String? createdAt;
  String? updatedAt;
  CreditStatusDetails? details;

  CreditStatusTransaction(
      {this.id,
      this.amount,
      this.netAmount,
      this.bankCharge,
  ...
  CreditStatusTransaction.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    amount = json['amount'];
    ...
    details = json['details'] != null
        ? CreditStatusDetails.fromJson(json['details'])
        : null;
  }
