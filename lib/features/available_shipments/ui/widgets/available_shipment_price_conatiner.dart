...
class AvailableShipmentPriceContainer extends StatelessWidget {
  final AvailableShipmentModel shipment;
  final ShipmentProductModel? product;
  const AvailableShipmentPriceContainer({
    super.key,
            ...
            child: Center(
              child: Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      '${shipment.slug != null ? shipment.amount?.toStringAsFixed0() : product!.price.toStringAsFixed(0)} جنية',
                      style: TextStyle(
                        fontSize: 12.0.sp,
